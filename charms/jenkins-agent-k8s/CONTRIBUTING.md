...
This document explains the processes and practices recommended for contributing enhancements to the jenkins agent k8s charm.

## Overview

- Generally, before developing enhancements to this charm, you should consider [opening an issue
  ](https://github.com/canonical/jenkins-operators/issues) explaining your use case.
...
- [Fork](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/working-with-forks/about-forks)
  our [GitHub repository](https://github.com/canonical/jenkins-operators)
...
Canonical welcomes contributions to the jenkins agent k8s charm. Please check out our
...
```
git clone https://github.com/canonical/jenkins-operators
```
...
OCI image for the jenkins agent k8s app, and then upload the image to a MicroK8s registry,
...
# Deploy the charm
juju deploy ./jenkins-agent-k8s*.charm
```
