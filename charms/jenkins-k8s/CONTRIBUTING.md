...
This document explains the processes and practices recommended for contributing enhancements to the jenkins k8s charm.
...
Canonical welcomes contributions to the jenkins k8s charm. Please check out our
...
OCI image for the jenkins k8s app, and then upload the image to a MicroK8s registry,
