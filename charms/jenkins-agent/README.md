...
[![Publish to edge](https://github.com/canonical/jenkins-operators/actions/workflows/jenkins_agent_publish.yaml/badge.svg)](https://github.com/canonical/jenkins-operators/actions/workflows/jenkins_agent_publish.yaml)
[![Promote charm](https://github.com/canonical/jenkins-operators/actions/workflows/jenkins_agent_publish.yaml/badge.svg)](https://github.com/canonical/jenkins-operators/actions/workflows/jenkins_agent_publish.yaml)
...
* [Issues](https://github.com/canonical/jenkins-operators/issues) <!--Link to GitHub issues (if applicable)-->
* [Contributing](https://github.com/canonical/jenkins-operators/blob/main/charms/jenkins-agent/CONTRIBUTING.md) <!--Link to any contribution guides--> 
