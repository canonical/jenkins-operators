...
This document explains the processes and practices recommended for contributing enhancements to the Jenkins agent charm.
...
Canonical welcomes contributions to the Jenkins agent charm. Please check out our
...
OCI image for the Jenkins agent app, and then upload the image to a MicroK8s registry,
